            ...
            <div className="grid gap-10 lg:grid-cols-[0.6fr_1.4fr] lg:gap-20">
              ...
              <Reveal delay={60} className="max-w-2xl space-y-5">
                <p className="text-base leading-relaxed text-muted">
                  ...
                  business to put it. That is backwards, and it is why so much
                  of what gets bought is quietly abandoned within a quarter.
                </p>
                <p className="text-base leading-relaxed text-muted">
                  We start from the constraint. Which process, measured in hours
                  and dollars, is actually costing you the most? What would
                  removing it be worth? Only once that has a number do we decide
                  what to build — and sometimes the answer is that nothing
                  should be built, which is a legitimate outcome of the work.
                </p>
                <p className="text-base leading-relaxed text-muted">
                  The categories below are the shapes this usually takes. They
                  are a description of past work, not a menu to choose from.
                </p>
              </Reveal>
            </div>
          </Container>
              ...
              <div className="gradient-deep relative mt-10 overflow-hidden rounded-2xl p-8 lg:p-12">
                ...
                <div className="relative mx-auto max-w-3xl text-center">
                  ...
                  <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-white/70">
                    A firm that promises a specific ROI on a first call is
                    either guessing or selling. We commit to something narrower
                    and more useful: the measurement will be honest, the
                    assumptions will be visible, and you will get the 90-day
                    comparison whichever way it goes. That commitment is in the
                    engagement terms, not just on this page.
                  </p>
                </div>
              </div>
            </Reveal>
