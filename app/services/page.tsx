          ...
          <div className="grid gap-10 lg:grid-cols-[0.6fr_1.4fr] lg:gap-20">
            ...
            <Reveal delay={60} className="max-w-2xl space-y-5">
              ...
              <p className="text-base leading-relaxed text-muted">
                ...
                what to build — and sometimes the answer is that nothing should
                be built, which is a legitimate outcome of the work.
              </p>
              <p className="text-base leading-relaxed text-muted">
              ...
              >
                <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr] lg:gap-14">
                  <div>
                    ...
                    <h3 className="card-title mt-5 text-2xl">
                      {service.title}
                    </h3>
          ...
          <div className="mt-16 grid gap-5 sm:grid-cols-2">
            {measurement.map((item, i) => (
              ...
              >
                ...
                <h3 className="card-title mt-5 text-xl">{item.title}</h3>
