            ...
            <div className="grid gap-10 lg:grid-cols-[0.6fr_1.4fr] lg:gap-20">
              ...
              <Reveal delay={60} className="max-w-2xl space-y-5">
                <p className="text-base leading-relaxed text-muted">
                  ...
                  timing processes, and building the financial case for whether
                  a piece of equipment would pay for itself. The discipline that
                ...
                <p className="text-base leading-relaxed text-muted">
                  ...
                  accounting practices, the clinics, the clubs, the
                  distributors, the firms that actually employ most Canadians —
                  was being sold the same technology with none of the scrutiny,
                  on a demo and a promise.
                </p>
                <p className="text-base leading-relaxed text-muted">
                  Almost nobody was establishing a baseline before building,
                  which meant almost nobody could say afterwards whether it had
                  worked. Owners were spending real money on capability and
                  hoping. A few got lucky. Most quietly stopped using what they
                  bought.
                </p>
                <p className="text-base leading-relaxed text-muted">
                  ...
                  , then re-measure and report what actually happened. It is not
                  a novel idea. It is ordinary engineering discipline applied to
                  a field that currently runs on enthusiasm — and applied for
                  businesses that have rarely been offered it.
                </p>
                <p className="text-base leading-relaxed text-muted">
                  Praxes is the Greek for practice: action informed by theory
                  rather than theory on its own. That is roughly the whole
                  point.
                </p>
              </Reveal>
            </div>
