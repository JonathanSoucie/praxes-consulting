...
export function Footer() {
  ...
  return (
    // relative z-10 so the home page's fixed canvas, which covers the viewport
    // for the whole flight, does not paint over the footer once the spine has
    // scrolled past. Every other page is unaffected.
    ...
    <footer className="relative z-10 bg-surface-2">
