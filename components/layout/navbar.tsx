        ...
        <div className="grid h-18 grid-cols-[1fr_auto_1fr] items-center gap-6 pb-[var(--frame-y)] lg:h-22">
          ...
          <div className="col-start-3 flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="-mr-2 inline-flex size-11 items-center justify-center rounded-sm text-ink transition-[background-color,transform] duration-150 ease-out-soft active:scale-90 active:bg-accent-soft lg:hidden"
            >
              {open ? (
